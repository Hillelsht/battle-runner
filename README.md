...
- **In Unity:** Window → General → **Test Runner** → EditMode → Run All (473 tests: gate math incl. soft-cap overflow, the gesture confusion suite, loot distribution + pity, save migration + checksum, crowd math incl. the formation envelope and lane partition, boss sim, state machine).
