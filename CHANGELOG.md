...
| Tests | 453, green under both `dotnet test` and Unity's Test Runner |
...
a zero. `StatFormat` in Core is now the single source of truth, pinned by eight new cases (the suite went 140 -> 162; it is 453 tests today).
